...
// chart data
import chartDataManagement from './chart-data/piechart';
import chartDataAdvisor from './chart-data/piechart-advisor';
import chartDataCordinator from './chart-data/piechart-cordinator';
                            ...
                            <Grid container alignItems="center" justifyContent="space-between">
                                <Grid item>
                                    <Grid container direction="column" spacing={1}>
                                        <Grid item>
                                            <Typography variant="subtitle2">Opportunities Chart</Typography>
                                        </Grid>
                                    </Grid>
                                </Grid>
                            </Grid>
